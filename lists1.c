...
/**
 * list_to_strings - this return arrays of strings of a list->str
...
/**
 * node_starts_with - will return nodes that its string start with prefix
...
/**
 * get_node_index - will get the index of nodes
