...
/**
 * _strlen - this returns length of a string
 * @s: particular string length to check.
 ...
 * Return: is negative if s1 < s2, positive if s1 > s2, zero if s1 == s2
 */
...
/**
 * starts_with - the checks if needle starts with haystack
